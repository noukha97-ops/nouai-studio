      ...
      <div className="flex-1 overflow-y-auto relative z-10 scrollbar-hide">
        <div className="max-w-[800px] mx-auto p-4 md:p-10 pb-40">
          ...
          <div className="flex justify-between items-center mb-8 px-2">
            ...
            <button 
              onClick={() => router.push('/')} 
              className="h-10 w-10 flex items-center justify-center bg-white/5 border border-white/10 text-zinc-400 hover:text-white hover:bg-white/10 rounded-full transition-all active:scale-95 shadow-lg"
            >
              <X size={18} />
            </button>
          </div>
          ...
          <div className="rounded-[30px] bg-[#050508]/80 border border-white/10 p-8 md:p-10 shadow-2xl backdrop-blur-2xl text-left space-y-6 text-zinc-300 text-[14px] leading-relaxed font-medium">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 mt-2 text-zinc-400">
                ...
                <li>Peb muaj txoj cai hloov pauv nqi Credits (Cost) raws li lub tshuab RunPod Server nce lossis nqis yav tom qab.</li>
              </ul>
            </section>
